...
module Bootstrap3::TabHelper
  ...
  class TabBuilder
    ...
    def to_s
      id = options.delete(:id) || 'tabs'
      default_tab_options = {id: id, class: 'nav nav-tabs'}
      default_pill_options = {id: id, class: 'nav nav-pills'}
      ...
      @template.content_tag('div', nil, class: tab_position_class, style: "padding-bottom:30px") do
