...
module Fdn
  class Enterprise < ActiveRecord::Base
    ...
    ###
    #ATTRIBUTE
    attr_accessor :province, :city, :ent_industry_value ,:cq_parent_name,:kb_parent_name,:ys_parent_name,:js_parent_name,:nb_parent_name,:dw_parent_name

    Fdn::OrgHierarchy.all.each do |hie|
      attr_accessor eval(":#{hie.code}_name")
    end
    ###
    #ASSOCIATION
    ...
    has_many :hr_ent_talents, :class_name => 'Hr::EntTalent', :foreign_key => 'ent_id'
