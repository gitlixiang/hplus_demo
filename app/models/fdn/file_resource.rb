class Fdn::FileResource < ActiveRecord::Base
  ...
  belongs_to :file_template, :class_name => 'Fdn::FileTemplate', :foreign_key => 'file_template_id'
  belongs_to :file_class, :class_name => 'Fdn::FileClass', :foreign_key => 'file_class_id'

  has_one :fdn_event, -> { where("fdn_events.resource_type = 'Fdn::FileResource'") }, :class_name => 'Fdn::Event', foreign_key: 'resource_id'
  accepts_nested_attributes_for :fdn_event, :allow_destroy => true
