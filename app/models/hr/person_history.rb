class Hr::PersonHistory < ActiveRecord::Base
  belongs_to :hr_person, :class_name => 'Hr::Person', foreign_key: :hr_person_id
  ...
  #   self.hr_person.send(method_name)
  # end

  default_scope -> { order('hr_person_id, entry_ways_date desc') }
