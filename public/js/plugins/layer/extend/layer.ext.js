...
!function () {
    ...
    layer.prompt = function (a, c) {
        ...
        return layer.open($.extend({btn: ["&#x786E;&#x5B9A;", "&#x53D6;&#x6D88;"], content: e, skin: "layui-layer-prompt" + b("prompt"), success: function (a) {
        ...
        a = a || {};
        var c = a.tab || {};
        return layer.open($.extend({type: 1, skin: "layui-layer-tab" + b("tab"), title: function () {
        ...
        if (a = a || {}, a.photos) {
            ...
            if (f.imgIndex = j + 1, g) {
                ...
                if (c || k.find(h.img || "img").each(function (b) {
                    var c = $(this);
                    i.push({alt: c.attr("alt"), pid: c.attr("layer-pid"), src: c.attr("layer-src") || c.attr("src"), thumb: c.attr("src")}), c.on("click", function () {
            ...
            f.imgprev = function (a) {
                ...
                layer.close(f.loadi), f.index = layer.open($.extend({type: 1, area: function () {
                ...
                layer.close(f.loadi), layer.msg("&#x5F53;&#x524D;&#x56FE;&#x7247;&#x5730;&#x5740;&#x5F02;&#x5E38;<br>&#x662F;&#x5426;&#x7EE7;&#x7EED;&#x67E5;&#x770B;&#x4E0B;&#x4E00;&#x5F20;&#xFF1F;", {time: 3e4, btn: ["下一张", "不看了"], yes: function () {
