...
!function (a) {
    ...
    var b = {init: function (b) {
        function c(b, c, d) {
            ...
            }, 100) : ("left" === d.listAlign ? c.css({left: b.siblings("div").width() - b.parent().width(), right: "auto"}) : "right" === d.listAlign && c.css({left: "auto", right: "0"}), d.autoMinWidth === !1 ? c.css({"min-width": b.parent().width()}) : c.css("width", "auto"), b)
        }
        ...
        function h(b, c, d, e) {
            ...
            if (b = b || "", e = e || s, e.url)m = -1 !== e.url.indexOf("?") ? "&" : "?", n = e.jsonp ? [e.url + b, m, e.jsonp, "=?"].join("") : e.url + b, a.ajax({type: "GET", url: n, dataType: "json", timeout: 3e3}).done(function (a) {
        ...
        function m(a, b, d) {
            var e, f, g, h, j, l, m, o = a.parent().find("ul.dropdown-menu"), p = 0, q = ['<table class="table table-condensed">'];
