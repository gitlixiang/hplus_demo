...
!function (a, b) {
    ...
    return b("dollar-third", [], function () {
        ...
        var d;
        return d = {Deferred: c, isPromise: function (a) {
        ...
        if (h)return d = {dv: 3, master: "webuploader", online: /test/.exec(g) ? 0 : 1, module: "", product: g, type: 0}, b.register({name: "log", init: function () {
