...
(function ($) {
    ...
    //method of operate data
        data = {
            ...
            getNodeClass: function (setting, node) {
                var classKey = setting.data.key.class;
                return "" + node[classKey];
            },
    ...
    //method of operate ztree dom
        view = {
            ...
            makeDOMNodeNameBefore: function (html, setting, node) {
                ...
                var classStr = data.getNodeClass(setting, node),
                ...
                html.push("<a id='", node.tId, consts.id.A, "' class='", classStr, consts.className.LEVEL, node.level, "' treeNode", consts.id.A, " onclick=\"", (node.click || ''),
